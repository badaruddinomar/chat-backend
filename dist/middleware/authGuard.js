...
exports.authenticateSocket = exports.authorizeRoles = exports.isAuthenticatedUser = void 0;
...
const authenticateSocket = (socket, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!token) {
            throw next(new AppError_1.default(http_status_1.default.UNAUTHORIZED, 'Please login to access this resource.'));
        }
        const decodedData = jsonwebtoken_1.default.verify(token, config_1.default.jwt_secret);
        const user = yield prismaClient_1.prisma.user.findUnique({
            where: { id: decodedData === null || decodedData === void 0 ? void 0 : decodedData.userId },
