...
const uploadSingleImage = (image, // req.files?.image as UploadedFile
folderName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield cloudinary_1.default.uploader.upload(image.tempFilePath, {
            folder: folderName,
        });
        return {
...
const deleteSingleImage = (publicId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const uploadMultipleImages = (images, // req.files?.images as UploadedFile[]
folderName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
