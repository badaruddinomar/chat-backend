...
exports.getUserProfile = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
exports.getAllUsers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const searchFilter = Object.assign({ isVerified: true }, (searchText && {
        OR: [
...
exports.updateUserProfile = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    ...
    if (avatar) {
        ...
        if (Array.isArray(avatar)) {
            return next(new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Only one image can be uploaded for avatar'));
        }
        // check avatar file type is valid---
        const validImageTypes = ['image/jpeg', 'image/png', 'image/webp'];
        if (!validImageTypes.includes(avatar.mimetype)) {
            return next(new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Invalid image type, image must be jpeg, png or webp'));
        }
        // check avatar file size--
        const MAX_SIZE = 2 * 1024 * 1024;
        if (avatar.size > MAX_SIZE) {
            return next(new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Image size must be less than 2MB'));
        }
        // Delete old avatar
        if ((_c = user.avatar) === null || _c === void 0 ? void 0 : _c.public_id) {
            yield (0, cloudinaryImageUpload_1.deleteSingleImage)(user.avatar.public_id);
        }
        // upload new avatar--
        avatarObj = yield (0, cloudinaryImageUpload_1.uploadSingleImage)(avatar, 'tohori_avatars');
    }
    ...
    const { password: _password } = updatedUser, userData = __rest(updatedUser, ["password"]);
    // Send response to client
    res.status(http_status_1.default.OK).json({
        success: true,
