...
exports.register = (0, catchAsync_1.default)((req, res, next) =>
...
exports.verifyEmail = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.resendVerifyCode = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.login = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.forgotPassword = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    // 1. Check if user exists
    const user = yield prismaClient_1.prisma.user.findUnique({
    ...
    yield (0, sendEmail_1.default)({
      ...
      body: (0, forgotPassEmailTemplate_1.forgotPasswordEmailTemplate)(
        forgotPasswordCode,
      ),
    });
    // 5. Respond to client
...
exports.verifyForgotPasswordCode = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.resetPassword = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    let payload;
    try {
      payload = jsonwebtoken_1.default.verify(
        token,
        config_1.default.jwt_secret,
      );
    } catch (_b) {
...
exports.logout = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
